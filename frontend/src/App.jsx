...
import {
  ...
  MoreVertical, RotateCcw, LayoutGrid, List, Smartphone, Laptop, Tv, Home, Shirt, Sparkles, Package, Utensils, Tag, Activity, ArrowRight, ChevronLeft, Lock, Store, Shield, ShieldCheck, Ban
} from 'lucide-react';
import {
...
const isApprovedAgent = (agent) => {
  ...
  if (
    ['pending', 'pending_approval', 'pending approval', 'under_verification', 'under verification', 'in_review', 'pending_verification', 'requested', 'new', 'submitted'].includes(status) &&
    agent.isActive !== true && agent.isApproved !== true
  ) {
    return false;
  }
        ...
        <div className="h-full flex flex-col justify-between py-6 px-4 overflow-hidden">
          <div className="flex flex-col flex-1 min-h-0">
            ...
            <nav className="space-y-1 overflow-y-auto flex-1 pr-1">
              ...
              {/* ── OVERVIEW ── */}
              <p className="px-4 pt-4 pb-1.5 text-[10px] font-black uppercase tracking-[0.15em] text-slate-500">Overview</p>
              <button
                onClick={() => handleTabSelect('dashboard')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'dashboard' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Layers className="w-4 h-4" /> Dashboard
              </button>

              {/* ── AGENT ── */}
              <p className="px-4 pt-5 pb-1.5 text-[10px] font-black uppercase tracking-[0.15em] text-slate-500">Agent</p>
              <button
                onClick={() => handleTabSelect('agents')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'agents' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Users className="w-4 h-4" /> Agent Directory
              </button>
              <button
                onClick={() => handleTabSelect('agent-performance')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'agent-performance' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'vendor-directory-enterprise' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'customers' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Users className="w-4 h-4" /> Customers
              </button>
              <button
                onClick={() => handleTabSelect('membership-cards-enterprise')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'membership-cards-enterprise' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'kyc' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'bookings' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Calendar className="w-4 h-4" /> Bookings
              </button>
              <button
                onClick={() => handleTabSelect('jobs')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'jobs' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Briefcase className="w-4 h-4" /> Job Applied
              </button>
              <button
                onClick={() => handleTabSelect('delivery-partners')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'delivery-partners' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Truck className="w-4 h-4" /> Delivery Partners
              </button>
              <button
                onClick={() => handleTabSelect('technicians')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'technicians' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Contact className="w-4 h-4" /> Technicians
              </button>
              <button
                onClick={() => handleTabSelect('executives')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'executives' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'tickets' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <MessageSquare className="w-4 h-4" /> Support
              </button>
              <button
                onClick={() => handleTabSelect('announcements')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'announcements' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
                <Megaphone className="w-4 h-4" /> Announcements
              </button>
              <button
                onClick={() => handleTabSelect('settings')}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${activeTab === 'settings' ? 'bg-primary-600 text-white shadow-md shadow-primary-600/15' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'}`}
              >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden">
        ...
        <main className="px-3 py-4 sm:p-6 max-w-7xl w-full mx-auto space-y-6">
          ...
          {activeTab === 'cyber-security' && (
            <SecurityDashboard token={token} API_BASE={API_BASE} />
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
                ...
                {(() => {
                  ...
                  // Helper utilities for agent display
                  const getAgentPincodeCode = (agent) => {
                    if (agent.assignedPincode?.code) return String(agent.assignedPincode.code);
                    if (typeof agent.assignedPincode === 'string' && /^\d{6}$/.test(agent.assignedPincode)) return agent.assignedPincode;
                    if (agent.pincode && /^\d{6}$/.test(agent.pincode)) return String(agent.pincode);
                    if (agent.assignedArea && /^\d{6}$/.test(agent.assignedArea)) return agent.assignedArea;
                    if (agent.assignedArea && agent.assignedArea.match(/\b\d{6}\b/)) return agent.assignedArea.match(/\b\d{6}\b/)[0];
                    return null;
                  };
                  ...
                  if (agentViewMode === 'tree') {
                    ...
                    filteredAgents.forEach((ag) => {
                      ...
                      if (lvl === 'state') {
                        hierarchyMap[stateName].stateAgents.push(ag);
                      } else {
                        if (!hierarchyMap[stateName].districts[districtName]) {
                          hierarchyMap[stateName].districts[districtName] = { districtName, districtAgents: [], divisions: {} };
                        }

                        if (lvl === 'district') {
                          hierarchyMap[stateName].districts[districtName].districtAgents.push(ag);
                        } else {
                          if (!hierarchyMap[stateName].districts[districtName].divisions[divisionName]) {
                            hierarchyMap[stateName].districts[districtName].divisions[divisionName] = { divisionName, divisionAgents: [], pincodeAgents: [] };
                          }
                      ...
                      <div className="space-y-4">
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                stateEntries.forEach(s => {
                                  ...
                                  s.stateAgents.forEach(sa => { allKeys[sa._id] = true; });
                                  Object.values(s.districts).forEach(d => {
                                    allKeys[d.districtName] = true;
                                    d.districtAgents.forEach(da => { allKeys[da._id] = true; });
                                    Object.values(d.divisions).forEach(v => {
                                      allKeys[v.divisionName] = true;
                                      v.divisionAgents.forEach(va => { allKeys[va._id] = true; });
                                    });
                                  });
                                });
                        ...
                        <div className="p-6 space-y-6 bg-slate-50/40 dark:bg-slate-950/20">
                          {stateEntries.map((stObj) => {
                            ...
                            return (
                              <div key={stKey} className="bg-white dark:bg-slate-900 border-2 border-blue-500/80 rounded-3xl p-4 shadow-sm space-y-3 transition-all">
                                {/* State Level: Render State Agent Card directly (or territory card if no state agent assigned) */}
                                {stObj.stateAgents.length > 0 ? (
                                  stObj.stateAgents.map((stAgent) => (
                                    <div
                                      key={stAgent._id}
                                      onClick={() => setExpandedAgents(prev => ({ ...prev, [stKey]: !isStExpanded }))}
                                      className="bg-blue-50/70 dark:bg-blue-950/40 border-2 border-blue-200 dark:border-blue-800 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 cursor-pointer hover:border-blue-400 transition-all group"
                                    >
                                      <div className="flex items-center gap-3">
                                        <button
                                          type="button"
                                          onClick={(e) => {
                                            e.stopPropagation();
                                            setExpandedAgents(prev => ({ ...prev, [stKey]: !isStExpanded }));
                                          }}
                                          className="w-8 h-8 rounded-full border border-blue-300 dark:border-blue-700 bg-blue-100 dark:bg-blue-900/60 text-blue-600 dark:text-blue-400 flex items-center justify-center hover:bg-blue-200 transition-all shadow-xs shrink-0 cursor-pointer"
                                        ...
                                        <div>
                                          <div className="flex items-center gap-2 flex-wrap">
                                            <span className="bg-blue-600 text-white text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider">STATE AGENT</span>
                                            <span className="text-xs font-mono text-slate-400 font-bold">ID: AG-STAT-{String(stAgent._id).slice(-4)}</span>
                                            <span className={`text-[10px] font-extrabold px-2 py-0.5 rounded-full capitalize ${stAgent?.status === 'approved' ? 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20' : 'bg-amber-500/10 text-amber-500'}`}>
                                              {stAgent?.status || 'Approved'}
                                            </span>
                                          </div>
                                          <h4 className="text-lg font-black text-slate-850 dark:text-slate-100 mt-1 group-hover:text-blue-500 transition-colors">
                                            {formatAgentNameWithPincode(stAgent)} ({stObj.stateName})
                                          </h4>
                                          <p className="text-xs text-slate-500 font-semibold mt-0.5">{stAgent.email} • {stAgent.phone}</p>
                                        </div>
                                      </div>
                                      ...
                                      <button
                                        ...
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          setModalData(stAgent);
                                          setShowModal('agent-profile');
                                        }}
                                        className="bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-sm cursor-pointer self-end sm:self-center shrink-0"
                                      >
                                        View Profile
                                      </button>
                                    </div>
                                  ...
                                  <div
                                    onClick={() => setExpandedAgents(prev => ({ ...prev, [stKey]: !isStExpanded }))}
                                    className="flex items-center justify-between p-3.5 bg-blue-50/50 dark:bg-blue-950/20 rounded-2xl border border-blue-200 dark:border-blue-900/40 cursor-pointer group"
                                  >
                                    <div className="flex items-center gap-3">
                                      <button
                                        type="button"
                                        className="w-7 h-7 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 flex items-center justify-center shrink-0"
                                      >
                                        <ChevronRight className={`w-4 h-4 transform transition-transform duration-200 ${isStExpanded ? 'rotate-90' : ''}`} />
                                      </button>
                                      <div>
                                        <span className="bg-blue-600/20 text-blue-700 dark:text-blue-300 text-[10px] font-black px-2 py-0.5 rounded-full uppercase">STATE TERRITORY</span>
                                        <h4 className="text-base font-bold text-slate-800 dark:text-slate-200 mt-0.5">
                                          📍 {stObj.stateName} State <span className="text-xs text-slate-400 font-normal">(No State Agent assigned)</span>
                                        </h4>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                {isStExpanded && (
                                  <div className="ml-2 sm:ml-6 pl-3 sm:pl-5 border-l-2 border-amber-400 dark:border-amber-600/70 space-y-3 pt-2">
                                    {districtList.map((distObj) => {
                                      ...
                                      return (
                                        <div key={distKey} className="bg-white dark:bg-slate-900 border-2 border-amber-500/70 rounded-2xl p-3 shadow-sm space-y-3">
                                          {/* District Agent Cards directly */}
                                          {distObj.districtAgents.length > 0 ? (
                                            distObj.districtAgents.map((distAgent) => (
                                              <div
                                                key={distAgent._id}
                                                onClick={() => setExpandedAgents(prev => ({ ...prev, [distKey]: !isDistExpanded }))}
                                                className="bg-amber-50/70 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-800 rounded-xl p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 cursor-pointer hover:border-amber-500 transition-all group"
                                              >
                                                <div className="flex items-center gap-3">
                                                  <button
                                                    type="button"
                                                    onClick={(e) => {
                                                      e.stopPropagation();
                                                      setExpandedAgents(prev => ({ ...prev, [distKey]: !isDistExpanded }));
                                                    }}
                                                    className="w-7 h-7 rounded-full border border-amber-300 dark:border-amber-700 bg-amber-100 dark:bg-amber-900/60 text-amber-600 dark:text-amber-400 flex items-center justify-center hover:bg-amber-200 transition-all shadow-xs shrink-0 cursor-pointer"
                                                  ...
                                                  <div>
                                                    <div className="flex items-center gap-2 flex-wrap">
                                                      <span className="bg-amber-500 text-white text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider">DISTRICT AGENT</span>
                                                      <span className="text-xs font-mono text-slate-400 font-bold">ID: AG-DIST-{String(distAgent._id).slice(-4)}</span>
                                                    ...
                                                    <h5 className="text-base font-bold text-slate-850 dark:text-slate-100 mt-0.5 group-hover:text-amber-500 transition-colors">
                                                      {formatAgentNameWithPincode(distAgent)}
                                                    </h5>
                                                    <p className="text-xs text-slate-500 font-semibold flex items-center gap-1 mt-0.5">
                                                      <MapPin className="w-3 h-3 text-amber-500" /> District Territory: <span className="font-bold text-slate-800 dark:text-slate-200">{distObj.districtName}</span> ({distAgent.email})
                                                    </p>
                                                  </div>
                                                </div>
                                            ...
                                            <div
                                              onClick={() => setExpandedAgents(prev => ({ ...prev, [distKey]: !isDistExpanded }))}
                                              className="flex items-center justify-between p-3 bg-amber-50/50 dark:bg-amber-950/20 rounded-xl border border-amber-200 dark:border-amber-900/40 cursor-pointer group"
                                            >
                                              <div className="flex items-center gap-2.5">
                                                <button
                                                  type="button"
                                                  className="w-6 h-6 rounded-full bg-amber-100 dark:bg-amber-900 text-amber-600 dark:text-amber-300 flex items-center justify-center shrink-0"
                                                >
                                                  <ChevronRight className={`w-3.5 h-3.5 transform transition-transform duration-200 ${isDistExpanded ? 'rotate-90' : ''}`} />
                                                </button>
                                                <div>
                                                  <span className="bg-amber-500/20 text-amber-700 dark:text-amber-300 text-[10px] font-black px-2 py-0.5 rounded-full uppercase">DISTRICT TERRITORY</span>
                                                  <h5 className="text-sm font-bold text-slate-800 dark:text-slate-200 mt-0.5">
                                                    📍 {distObj.districtName} District <span className="text-xs text-slate-400 font-normal">(No District Agent assigned)</span>
                                                  </h5>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          {isDistExpanded && (
                                            <div className="ml-2 sm:ml-5 pl-3 sm:pl-4 border-l-2 border-purple-400 dark:border-purple-600/70 space-y-3 pt-2">
                                              {divList.map((divObj) => {
                                                ...
                                                return (
                                                  <div key={divKey} className="bg-white dark:bg-slate-900 border-2 border-purple-500/70 rounded-2xl p-3 shadow-sm space-y-2.5">
                                                    {/* Divisional Agent Cards directly */}
                                                    {divObj.divisionAgents.length > 0 ? (
                                                      divObj.divisionAgents.map((divAgent) => (
                                                        <div
                                                          key={divAgent._id}
                                                          onClick={() => setExpandedAgents(prev => ({ ...prev, [divKey]: !isDivExpanded }))}
                                                          className="bg-purple-50/70 dark:bg-purple-950/40 border border-purple-300 dark:border-purple-800 rounded-xl p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2 cursor-pointer hover:border-purple-500 transition-all group"
                                                        >
                                                          <div className="flex items-center gap-2.5">
                                                            <button
                                                              type="button"
                                                              onClick={(e) => {
                                                                e.stopPropagation();
                                                                setExpandedAgents(prev => ({ ...prev, [divKey]: !isDivExpanded }));
                                                              }}
                                                              className="w-6 h-6 rounded-full border border-purple-300 dark:border-purple-700 bg-purple-100 dark:bg-purple-900/60 text-purple-600 dark:text-purple-400 flex items-center justify-center hover:bg-purple-200 transition-all shadow-xs shrink-0 cursor-pointer"
                                                            ...
                                                            <div>
                                                              <div className="flex items-center gap-2 flex-wrap">
                                                                <span className="bg-purple-600 text-white text-[9px] font-black px-2.5 py-0.5 rounded-full uppercase">DIVISIONAL AGENT</span>
                                                                <span className="text-[11px] font-mono text-slate-400 font-bold">ID: AG-DIV-{String(divAgent._id).slice(-4)}</span>
                                                              </div>
                                                              <h6 className="text-sm font-bold text-slate-850 dark:text-slate-100 mt-0.5 group-hover:text-purple-500 transition-colors">
                                                                {formatAgentNameWithPincode(divAgent)}
                                                              </h6>
                                                              <p className="text-[11px] text-slate-500 font-semibold flex items-center gap-1 mt-0.5">
                                                                <MapPin className="w-3 h-3 text-purple-500" /> Division Territory: <span className="font-bold text-slate-800 dark:text-slate-200">{divObj.divisionName}</span> ({divAgent.email})
                                                              </p>
                                                            </div>
                                                          </div>
                                                      ...
                                                      <div
                                                        onClick={() => setExpandedAgents(prev => ({ ...prev, [divKey]: !isDivExpanded }))}
                                                        className="flex items-center justify-between p-2.5 bg-purple-50/50 dark:bg-purple-950/20 rounded-xl border border-purple-200 dark:border-purple-900/40 cursor-pointer group"
                                                      >
                                                        <div className="flex items-center gap-2">
                                                          <button
                                                            type="button"
                                                            className="w-5 h-5 rounded-full bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-300 flex items-center justify-center shrink-0"
                                                          >
                                                            <ChevronRight className={`w-3 h-3 transform transition-transform duration-200 ${isDivExpanded ? 'rotate-90' : ''}`} />
                                                          </button>
                                                          <div>
                                                            <span className="bg-purple-600/20 text-purple-700 dark:text-purple-300 text-[9px] font-black px-2 py-0.5 rounded-full uppercase">DIVISION TERRITORY</span>
                                                            <h6 className="text-xs font-bold text-slate-800 dark:text-slate-200 mt-0.5">
                                                              📍 {divObj.divisionName} Division <span className="text-[11px] text-slate-400 font-normal">(No Divisional Agent assigned)</span>
                                                            </h6>
                                                          </div>
                                                        </div>
                                                      </div>
                                                        ...
                                                        {pinAgents.map((pinAgent) => {
                                                          ...
                                                          return (
                                                            <div
                                                              ...
                                                              className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-l-4 border-l-emerald-500 cursor-pointer hover:border-emerald-400 transition-all"
                                                            >
                                                              <div className="flex items-center gap-2.5">
                                                                ...
                                                                <div className="group">
                                                                  ...
                                                                  <span className="text-[11px] text-slate-500 font-semibold flex items-center gap-1 mt-0.5">
                                                                    <MapPin className="w-3 h-3 text-emerald-500" /> Pincode: <span className="font-mono font-bold text-slate-800 dark:text-slate-200">{pinCode || '560096'}</span> ({pinAgent.email})
                                                                  </span>
                                                                </div>
                                                              </div>
                  ...
                  return agentViewMode === 'list' ? (
                    <div className="divide-y divide-slate-200 dark:divide-slate-800">
                      {filteredAgents.map((agent) => {
                        ...
                        const displayName = formatAgentNameWithPincode(agent);
      ...
      {showModal === 'banner' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-white dark:bg-slate-900 border dark:border-slate-800 w-full max-w-md rounded-3xl p-6 space-y-6">
            ...
            >
              <div>
                <label className="block text-xs font-semibold text-slate-400 uppercase mb-2">Title (Optional)</label>
                <input name="title" type="text" placeholder="e.g. Special Promotion Offer" className="w-full bg-slate-50 dark:bg-slate-950 border rounded-xl px-3.5 py-2 text-sm" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
